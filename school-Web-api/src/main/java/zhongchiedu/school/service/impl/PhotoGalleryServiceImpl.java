...
//			}
	...
	public void photoGalleryImgUpload(String id, MultipartFile[] file) {
		if(Common.isNotEmpty(id)) {
			...
			List<MultiMedia>  multi = 	this.multiMediaService.uploadPictures(file, dir, imgpath+Common.generatedate()+File.separator, "PHOTOGALLERY");
	...
	@Override
	public List<MultiMedia> findImgs(Integer num) {
		// TODO Auto-generated method stub
		return null;
	}
