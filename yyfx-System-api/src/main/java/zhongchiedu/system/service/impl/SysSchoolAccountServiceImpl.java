...
//@Service
//@Slf4j
//public class SysSchoolAccountServiceImpl extends GeneralServiceImpl<SysUser> implements SysUserService{
//
//	
//	
//	@Autowired
...
//	 */
//	@Override
//	public void saveOrUpdate(SysUser school,String roleId ,MultipartFile[] file ,String imgPath,String dir,String oldheadImg) {
//		SysUser getSchoolAccount = null;
//		List<MultiMedia> schoolHead = null; 
//			schoolHead = this.multiMediaSerice.uploadPictures(file, dir, imgPath, "SCHOOLMANAGER",105,105);
//	
//		if(Common.isNotEmpty(school.getId())){
//			getSchoolAccount = this.findOneById(school.getId(), SysUser.class);
//			if(Common.isNotEmpty(getSchoolAccount)){
//				school.setPhotograph(Common.isNotEmpty(oldheadImg)?getSchoolAccount.getPhotograph():null);
//				school.setAccountName(getSchoolAccount.getAccountName());
//			}
//		}
//		if(schoolHead.size()>0){
//			school.setPhotograph(schoolHead.get(0));
//		}
//		SysRole role = this.sysRoleService.findOneById(roleId, SysRole.class);
//		school.setRole(role != null ? role : null);
//		if(Common.isNotEmpty(getSchoolAccount)){
//			BeanUtils.copyProperties(school, getSchoolAccount);
//			this.save(school);
//		}else{
//			this.insert(school);
//		}
...
//	
//	@Override
//	public String delete(String id,SysUser sschool) {
//		try {
//			lock.lock();
//			List<String> ids = Arrays.asList(id.split(","));
//			String loginid = Common.isNotEmpty(sschool)?sschool.getId():"";
//			for (String edid : ids) {
//				//不能删除自己的账号
//				if(edid!=loginid) {
...
//		}
//		SysUser school = this.findOneById(id, SysUser.class);
//		if(Common.isEmpty(school)){
//			return BasicDataResult.build(400, "未能获取到数据，请刷新后再试", null);
//		}
//		if(school.getPassWord().equals(password)){
...
//		}
//		SysUser sc = this.findOneById(id, SysUser.class);
//		if(Common.isEmpty(sc)){
//			return BasicDataResult.build(400, "未能获取到数据，请刷新后再试", null);
//		}
